...
const reviews = [
  {
    ...
    text: 'We cried looking at our photos for the first time. Not because they were pretty — because they were real. Every tear, every laugh, every quiet in-between moment was captured with such soul. Eternal didn\'t document our wedding; they preserved our love story forever.',
    rating: 5,
    avatar: 'A',
  },
  {
    ...
    text: 'I\'ve seen hundreds of wedding photographs but nothing prepared me for what Eternal delivered. The cinematic quality, the emotional depth — it felt like watching a film of our lives. Our families were completely speechless. Worth every single rupee.',
    rating: 5,
    avatar: 'R',
  },
  {
  ...
  },
  {
    ...
    text: 'Booking Eternal was the best wedding decision we made — after saying yes to each other. The team was invisible during the day but somehow captured everything. Magic is the only word I have for what they do.',
    rating: 5,
    avatar: 'K',
  },
  {
    ...
    text: 'Our destination wedding in Kerala was a logistical dream and a photographic masterpiece thanks to Eternal. They scouted locations, understood the light, and created imagery that belongs in a museum. We are forever grateful.',
    rating: 5,
    avatar: 'V',
  },
];
